...
public class PermissionMapperTest {
	...
	@Test
	public void testOr() {
		Condition condition=mapper.createCondtion().andDescEqualTo("编辑产品").OR().andDescEqualTo("1111");
		System.out.println(mapper.selectByCondition(condition));
	}
	
	@Test
	public void testInclude() {
		Condition condition1=mapper.createCondtion().andDescEqualTo("编辑产品").andNameEqualTo("editeProduct");
		Condition condition2=mapper.createCondtion().andDescEqualTo("修改产品").andNameEqualTo("updateProduct");
		System.out.println(mapper.selectByCondition(mapper.createCondtion().includ(condition1).OR().includ(condition2)));
	}
